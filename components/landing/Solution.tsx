      ...
      <div className="container-wide mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 bg-blue-500/10 border border-blue-500/20 rounded-full px-4 py-1.5 mb-6">
            ...
            <span className="text-sm text-blue-400 font-medium">La solution</span>
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5 mb-16">
          {pillars.map((p, i) => (
            <div key={i} className={`bg-gradient-to-br ${p.color} border rounded-2xl p-6 hover:-translate-y-1 transition-transform`}>
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          ...
          <div className="bg-gradient-to-br from-blue-950/40 to-violet-950/30 border border-blue-800/30 rounded-2xl p-7">
            ...
            {[
              ...
              <div key={i} className="flex items-center gap-3 py-2.5 border-b border-blue-900/30 last:border-0">
